...
template <class T, size_t Dim> class test_array
{
public:
...
template <class T, size_t Dim> class test_array2 : public test_array<T, Dim>
{
};
...
namespace numeric
{
    namespace odeint
    {
        ...
        template <class T, size_t Dim> struct state_wrapper<test_array<T, Dim>>
        {
        ...
        // provide the state_wrapper
        template <class T, size_t Dim> struct state_wrapper<test_array2<T, Dim>>
        {
...
BOOST_AUTO_TEST_CASE(dense_output_dopri5_copy_construct)
{
    ...
    CHECK_COUNTERS(4 * 1 + 3 * 2 + 2 * 2, 4 * (1 + 6) + 3 * 2 + 2 * 2, 4 * 1 + 3 * 2 + 2 * 2, 4 * (1 + 6) + 3 * 2 + 2 * 2, 3 * 1 + 2 * 2 + 1 * 2,
                   3 * (6 + 1) + 2 * 2 + 2);
}
...
BOOST_AUTO_TEST_CASE(dense_output_dopri5_assign)
{
    ...
    CHECK_COUNTERS(6 * 1 + 4 * 2 + 2 * 2, 6 * (6 + 1) + 4 * 2 + 2 * 2, 6 * 1 + 4 * 2 + 2 * 2, 6 * (6 + 1) + 4 * 2 + 2 * 2, 5 * 1 + 3 * 2 + 2,
                   5 * (6 + 1) + 3 * 2 + 2);
}
