...
template <class Obj, class Mem> class observer_wrapper
{
    Obj m_obj;
    Mem m_mem;
...
public:
    ...
    template <class State, class Time> void operator()(const State& x, Time t)
    {
        (m_obj.*m_mem)(x, t);
    }
};

template <class Obj, class Mem> observer_wrapper<Obj, Mem> make_observer_wrapper(Obj obj, Mem mem)
{
