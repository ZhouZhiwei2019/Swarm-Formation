...
namespace numeric
{
    namespace odeint
    {
        ...
        template <> struct same_size_impl<test_array_type, test_array_type>
        {
        ...
        template <> struct resize_impl<test_array_type, test_array_type>
        {
...
typedef mpl::vector<mpl::vector<euler_manual_type, mpl::int_<1>, mpl::int_<0>>, mpl::vector<euler_initially_type, mpl::int_<1>, mpl::int_<1>>,
                    mpl::vector<euler_always_type, mpl::int_<1>, mpl::int_<3>>, mpl::vector<rk4_manual_type, mpl::int_<5>, mpl::int_<0>>,
                    mpl::vector<rk4_initially_type, mpl::int_<5>, mpl::int_<1>>, mpl::vector<rk4_always_type, mpl::int_<5>, mpl::int_<3>>,
                    mpl::vector<rk4_gen_manual_type, mpl::int_<5>, mpl::int_<0>>, mpl::vector<rk4_gen_initially_type, mpl::int_<5>, mpl::int_<1>>,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_resize, T, resize_check_types)
{
    ...
    BOOST_CHECK_MESSAGE(adjust_size_count == resize_calls * multiplicity,
                        "adjust_size_count : " << adjust_size_count << " expected: " << resize_calls * multiplicity);
}
