...
BOOST_AUTO_TEST_CASE_TEMPLATE(for_each8, algebra_type, algebra_types)
{
    algebra_type            algebra;
    boost::array<double, 2> x1 = { { 1.0, 1.0 } }, x2 = { { 2.0, 2.0 } }, x3 = { { 3.0, 3.0 } }, x4 = { { 4.0, 4.0 } }, x5 = { { 5.0, 5.0 } },
                            x6 = { { 6.0, 6.0 } }, x7 = { { 7.0, 7.0 } }, x8 = { { 8.0, 8.0 } };
...
struct adder
{
    template <typename Value, typename T1, typename T2> Value operator()(Value val, T1 t1, T2 t2) const
    {
        return val + t1 + t2;
    }

    template <typename Value, typename T1, typename T2, typename T3> Value operator()(Value val, T1 t1, T2 t2, T3 t3) const
    {
        return val + t1 + t2 + t3;
    }

    template <typename Value, typename T1, typename T2, typename T3, typename T4> Value operator()(Value val, T1 t1, T2 t2, T3 t3, T4 t4) const
    {
