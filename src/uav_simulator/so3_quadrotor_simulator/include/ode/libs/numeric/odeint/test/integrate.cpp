...
template <class Stepper> struct perform_integrate_const_test
{
...
template <class Stepper> struct perform_integrate_adaptive_test
{
...
template <class Stepper> struct perform_integrate_times_test
{
...
template <class Stepper> struct perform_integrate_n_steps_test
{
...
class stepper_methods
    : public mpl::vector<euler<state_type>, modified_midpoint<state_type>, runge_kutta4<state_type>, runge_kutta_cash_karp54<state_type>,
                         runge_kutta_dopri5<state_type>, runge_kutta_fehlberg78<state_type>, controlled_runge_kutta<runge_kutta_cash_karp54<state_type>>,
                         controlled_runge_kutta<runge_kutta_dopri5<state_type>>, controlled_runge_kutta<runge_kutta_fehlberg78<state_type>>,
                         bulirsch_stoer<state_type>, dense_output_runge_kutta<controlled_runge_kutta<runge_kutta_dopri5<state_type>>>
