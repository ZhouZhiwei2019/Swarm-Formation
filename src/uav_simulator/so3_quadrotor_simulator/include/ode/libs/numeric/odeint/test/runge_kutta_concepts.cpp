...
template <class Stepper, class System> void check_stepper_concept(Stepper& stepper, System system, typename Stepper::deriv_type& x)
{
...
template <class Stepper> struct perform_stepper_test<Stepper, vector_type>
{
    void operator()(void)
    {
        vector_type x(1, 2.0);
...
template <class Stepper> struct perform_stepper_test<Stepper, vector_space_type>
{
...
template <class Stepper> struct perform_stepper_test<Stepper, array_type>
{
    void operator()(void)
    {
        array_type x;
...
class stepper_methods : public mpl::vector<euler<State, double, State, double, typename algebra_dispatcher<State>::type>,
...
typedef mpl::copy<container_types, mpl::inserter<mpl::vector0<>, mpl::insert_range<mpl::_1, mpl::end<mpl::_1>, stepper_methods<mpl::_2>>>>::type
    all_stepper_methods;
