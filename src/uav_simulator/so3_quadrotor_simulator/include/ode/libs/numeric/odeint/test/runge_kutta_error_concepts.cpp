...
template <class Stepper> struct perform_error_stepper_test<Stepper, vector_type>
{
    void operator()(void)
    {
...
template <class Stepper> struct perform_error_stepper_test<Stepper, vector_space_type>
{
...
template <class Stepper> struct perform_error_stepper_test<Stepper, array_type>
{
    void operator()(void)
    {
        array_type x, xerr;
...
class error_stepper_methods : public mpl::vector<runge_kutta_cash_karp54_classic<State, double, State, double, typename algebra_dispatcher<State>::type>,
...
typedef mpl::copy<container_types, mpl::inserter<mpl::vector0<>, mpl::insert_range<mpl::_1, mpl::end<mpl::_1>, error_stepper_methods<mpl::_2>>>>::type
